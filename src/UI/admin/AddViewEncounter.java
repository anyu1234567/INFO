 ...
 * @author An
 */
public class AddViewEncounter extends javax.swing.JPanel {

    /**
     * Creates new form AddViewEncounter
     */
    JPanel userProcessContainer;
    Person p;
    public AddViewEncounter(JPanel userJP,Person p) {
        initComponents();
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Time slot：(eg.2021-10-30 21:00)");
    ...
    private void backAction() {
        ...
        ViewEncounterJPanel viewEncounterJPanel = (ViewEncounterJPanel) c;
        viewEncounterJPanel.refreshEncounterTable();
